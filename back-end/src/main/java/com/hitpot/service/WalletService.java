...
public class WalletService {
    ...
    private static final long PRICE_OF_HIT_DEFAULT = 20_000L;
    private static final long TOTAL_HIT_FOR_PER_HOUR = 100_000_000_000L;
    ...
    public WalletVO detailWallet(String userId) {
        ...
        return WalletVO.builder()
            .userId(userId)
            .balancePot(convertToEtherFromMwei(wallet.getBalancePot()))
    ...
    public void withdrawPot(String userId, double amountPotOfEther) {
        Wallet wallet = walletRepository.findFirstByUserId(userId);
        long amountPot = convertToMweiFromEther(amountPotOfEther);
    ...
    public void contentCollectHit(String userId, ContentCollectForm contentCollectForm) {
        ...
        long amountHit = convertToMweiFromEther(contentCollectForm.getAmountHit());
    ...
    public void purchaseContentNft(String userId, ContentPurchaseNftForm contentPurchaseNftForm) {
        ...
        // 判断钱包的余额是否充足
        long amountPot = convertToMweiFromEther(contentPurchaseNftForm.getAmountPot());
    ...
    public void exchangeHit(String userId, ExchangeHitForm exchangeHitForm) {
        ...
        long amountHitOfMwei = convertToMweiFromEther(amountHit);
        long amountPotOfMwei = convertToMweiFromEther(amountPot);
    ...
    public void watchConsume(User user, ContentWatch contentWatch, WatchForm watchForm) {
        ...
        long consumeHit = convertToMweiFromEther(userLevelPermission.getAmountHitPerSecond() * watchForm.getDuration());
     ...
     * 将ether转为Mwei
     */
    public Long convertToMweiFromEther(double amount) {
     ...
     * 将Mwei转换为ether
     */
    public double convertToEtherFromMwei(long amount) {
